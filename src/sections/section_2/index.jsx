  ...
  return (
    <div className="relative flex h-[800px] flex-col bg-[rgba(255,255,255,0.45)] md:h-[1125px]">
      ...
      <div className="flex h-full w-full flex-col justify-center pt-10 md:flex-row md:items-center md:gap-6 md:pt-[100px]">
        ...
        <CardWithPin className="-top-[70px] left-[42%] md:left-0 md:top-[80px]">
        ...
        <CardWithPin isFull className={'-top-[115px] md:left-0 md:top-0'}>
      ...
      <div className="md-py-0 relative mx-auto flex h-full max-h-[220px] w-full items-center justify-start rounded-tl-[45px] bg-yellow-light py-4 md:right-[7%] md:mt-[200px] md:max-h-[345px] md:w-fit md:justify-center md:pl-[10%] md:pr-[25%]">
        <div className="ml-[12%] max-w-[650px]">
          <h1 className="font-orenji text-small leading-[25px] text-red-primary md:text-[50px] md:leading-[62px]">
            Có thể là...
          </h1>
          <p className="max-w-[160px] pt-4 text-justify text-extraSmall leading-[22px] md:max-w-full md:pt-0 md:text-4xl md:leading-[43px]">
        ...
        <div className="absolute -right-[8%] bottom-0 max-w-[238px] md:-right-[22%] md:max-w-[550px]">
          <img
            alt="section2_mascot"
