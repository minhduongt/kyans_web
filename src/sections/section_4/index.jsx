...
function SectionFour() {
  return (
    <div className="relative h-[2720px] bg-[#F7EFE1]">
      <h1 className="font-orenji absolute left-1/2 -translate-x-1/2 -translate-y-1/2 whitespace-nowrap rounded-[45px] bg-red-primary px-[60px] py-[20px] text-h1 text-white">
        Đối tác dự án
      </h1>
      <div
        id="partners"
